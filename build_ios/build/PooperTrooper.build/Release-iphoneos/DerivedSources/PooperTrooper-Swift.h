...
#ifndef POOPERTROOPER_SWIFT_H
#define POOPERTROOPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PooperTrooper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC13PooperTrooper14AVAudioHandler")
...
SWIFT_CLASS("_TtC13PooperTrooper9AdManager")
...
@interface AdManager (SWIFT_EXTENSION(PooperTrooper)) <GADFullScreenContentDelegate>
...
@class UIWindow;
@class UIApplication;
SWIFT_CLASS("_TtC13PooperTrooper11AppDelegate")
...
SWIFT_CLASS("_TtC13PooperTrooper17GameCenterManager")
...
@interface GameCenterManager (SWIFT_EXTENSION(PooperTrooper)) <GKGameCenterControllerDelegate>
...
/// Direct C++ instantiation: std::make_unique<a href="PooperTrooper::GameEngine">PooperTrooper::GameEngine</a>()
...
SWIFT_CLASS("_TtC13PooperTrooper10GameEngine")
...
/// Direct C++ instantiation: std::make_unique<a href="FloppyTurd::GameViewController">FloppyTurd::GameViewController</a>()
/// Manages the Metal view, game engine lifecycle, and user input
SWIFT_CLASS("_TtC13PooperTrooper18GameViewController")
...
@class UITouch;
@class UIEvent;
@interface GameViewController (SWIFT_EXTENSION(PooperTrooper)) <MTKViewDelegate>
...
SWIFT_CLASS("_TtC13PooperTrooper12StoreManager")
...
SWIFT_CLASS("_TtC13PooperTrooper17TouchInputHandler")
@interface TouchInputHandler : NSObject <UIGestureRecognizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIGestureRecognizer;
@interface TouchInputHandler (SWIFT_EXTENSION(PooperTrooper))
...
/// auto handler = std::make_unique<a href="FloppyTurd::iOSLogHandler">FloppyTurd::iOSLogHandler</a>();
/// GNLog::GetInstance().AddHandler(std::move(handler));
/// Provides native iOS logging through os_log with full GNLog integration.
SWIFT_CLASS("_TtC13PooperTrooper13iOSLogHandler")
@interface iOSLogHandler : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("PooperTrooper", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace PooperTrooper SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("PooperTrooper") {
namespace _impl {
extern "C" {
#endif

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 {
  uint64_t _1;
  uint64_t _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16(char * _Nonnull result, struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 {
  uint64_t _1;
  uint64_t _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 $s13PooperTrooper10AssetErrorO16errorDescriptionSSSgvg(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct PooperTrooper_AssetError {
  _Alignas(8) char _storage[16];
};

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(char * _Nonnull result, struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 $s13PooperTrooper9AssetInfoV4nameSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_PooperTrooper_uint8_t_0_1 {
  uint8_t _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_PooperTrooper_uint8_t_0_1(char * _Nonnull result, struct swift_interop_returnStub_PooperTrooper_uint8_t_0_1 value) {
  memcpy(result + 0, &value._1, 1);
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint8_t_0_1 $s13PooperTrooper9AssetInfoV4typeAA0C4TypeOvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 $s13PooperTrooper9AssetInfoV4pathSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN uint64_t $s13PooperTrooper9AssetInfoV4sizes6UInt64Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 {
  uint64_t _1;
  uint64_t _2;
  uint64_t _3;
  uint64_t _4;
...
static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32(const char * _Nonnull value) {
  struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
...
SWIFT_EXTERN ptrdiff_t $s13PooperTrooper16AssetMemoryUsageV07textureD0Sivg(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s13PooperTrooper16AssetMemoryUsageV05audioD0Sivg(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s13PooperTrooper16AssetMemoryUsageV04dataD0Sivg(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s13PooperTrooper16AssetMemoryUsageV05totalD0Sivg(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct PooperTrooper_AssetMemoryUsage {
  _Alignas(8) char _storage[32];
};

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint8_t_0_1 $s13PooperTrooper9AssetTypeO8rawValueACSgSS_tcfC(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_PooperTrooper_void_ptr_0_8 {
  void * _Nullable _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_PooperTrooper_void_ptr_0_8(char * _Nonnull result, struct swift_interop_returnStub_PooperTrooper_void_ptr_0_8 value) {
  memcpy(result + 0, &value._1, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_void_ptr_0_8 $s13PooperTrooper9AssetTypeO8allCasesSayACGvgZ(void) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_PooperTrooper_uint8_t_0_1 {
  uint8_t _1;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_PooperTrooper_uint8_t_0_1 swift_interop_passDirect_PooperTrooper_uint8_t_0_1(const char * _Nonnull value) {
  struct swift_interop_passStub_PooperTrooper_uint8_t_0_1 result;
  memcpy(&result._1, value + 0, 1);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 $s13PooperTrooper9AssetTypeO8rawValueSSvg(struct swift_interop_passStub_PooperTrooper_uint8_t_0_1 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct PooperTrooper_AssetType {
  _Alignas(1) char _storage[1];
};

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint8_t_16_17 {
  uint64_t _1;
  uint64_t _2;
  uint8_t _3;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint8_t_16_17 swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint8_t_16_17(const char * _Nonnull value) {
  struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint8_t_16_17 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  memcpy(&result._3, value + 16, 1);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16 $s13PooperTrooper10AudioErrorO16errorDescriptionSSSgvg(struct swift_interop_passStub_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint8_t_16_17 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct PooperTrooper_AudioError {
  _Alignas(8) char _storage[17];
};

SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint8_t_0_1 $s13PooperTrooper8LogLevelO8rawValueACSgs5Int32V_tcfC(int32_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_void_ptr_0_8 $s13PooperTrooper8LogLevelO8allCasesSayACGvgZ(void) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s13PooperTrooper8LogLevelO8rawValues5Int32Vvg(struct swift_interop_passStub_PooperTrooper_uint8_t_0_1 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct PooperTrooper_LogLevel {
  _Alignas(1) char _storage[1];
};

SWIFT_EXTERN bool $s13PooperTrooper25hasRemoveAdsPurchasedSyncSbyF(void) SWIFT_NOEXCEPT SWIFT_CALL; // hasRemoveAdsPurchasedSync()
SWIFT_EXTERN struct swift_interop_returnStub_PooperTrooper_uint64_t_0_8_void_ptr_8_16 $s13PooperTrooper16loadGameDataSyncSSyF(void) SWIFT_NOEXCEPT SWIFT_CALL; // loadGameDataSync()
...
class SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO") AssetError;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<PooperTrooper::AssetError> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_AssetError;

// Type metadata accessor for AssetError
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13PooperTrooper10AssetErrorOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO") AssetError final {
public:
  SWIFT_INLINE_THUNK ~AssetError() noexcept {
    auto metadata = _impl::$s13PooperTrooper10AssetErrorOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AssetError(const AssetError &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper10AssetErrorOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetError &operator =(const AssetError &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper10AssetErrorOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetError &operator =(AssetError &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AssetError(AssetError &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    fileNotFound SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO12fileNotFoundyACSScACmF"),
    metalNotAvailable SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO17metalNotAvailableyA2CmF"),
    unknownError SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO07unknownD0yA2CmF")
  };

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_fileNotFound {  // impl struct for case fileNotFound
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::fileNotFound;
    }
    SWIFT_INLINE_THUNK AssetError operator()(const swift::String& val) const;
  } fileNotFound SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO12fileNotFoundyACSScACmF");
  SWIFT_INLINE_THUNK bool isFileNotFound() const;
  SWIFT_INLINE_THUNK swift::String getFileNotFound() const;

  inline const static struct _impl_metalNotAvailable {  // impl struct for case metalNotAvailable
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::metalNotAvailable;
    }
    SWIFT_INLINE_THUNK AssetError operator()() const;
  } metalNotAvailable SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO17metalNotAvailableyA2CmF");
  SWIFT_INLINE_THUNK bool isMetalNotAvailable() const;

  inline const static struct _impl_unknownError {  // impl struct for case unknownError
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::unknownError;
    }
    SWIFT_INLINE_THUNK AssetError operator()() const;
  } unknownError SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO07unknownD0yA2CmF");
  SWIFT_INLINE_THUNK bool isUnknownError() const;

#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    switch (_getEnumTag()) {
      case 0: return cases::fileNotFound;
      case 1: return cases::metalNotAvailable;
      case 2: return cases::unknownError;
      default: abort();
    }
  }

  SWIFT_INLINE_THUNK swift::Optional<swift::String> getErrorDescription() const SWIFT_SYMBOL("s:13PooperTrooper10AssetErrorO16errorDescriptionSSSgvp");
private:
  SWIFT_INLINE_THUNK AssetError() noexcept {}
  static SWIFT_INLINE_THUNK AssetError _make() noexcept { return AssetError(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }
  ...
  alignas(8) char _storage[16];
  friend class _impl::_impl_AssetError;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13PooperTrooper10AssetErrorOD;
  static inline constexpr $s13PooperTrooper10AssetErrorOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AssetError {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AssetError &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AssetError &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AssetError returnNewValue(T callable) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<PooperTrooper::AssetError> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return PooperTrooper::_impl::$s13PooperTrooper10AssetErrorOMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<PooperTrooper::AssetError> = true;
template<>
struct implClassFor<PooperTrooper::AssetError> { using type = PooperTrooper::_impl::_impl_AssetError; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO") AssetType;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<PooperTrooper::AssetType> = true;
#pragma clang diagnostic pop
} // namespace swift

namespace PooperTrooper SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("PooperTrooper") {
class SWIFT_SYMBOL("s:13PooperTrooper9AssetInfoV") AssetInfo;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<PooperTrooper::AssetInfo> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13PooperTrooper9AssetInfoVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13PooperTrooper9AssetInfoV") AssetInfo final {
public:
  SWIFT_INLINE_THUNK ~AssetInfo() noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetInfoVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AssetInfo(const AssetInfo &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetInfoVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetInfo &operator =(const AssetInfo &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetInfoVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetInfo &operator =(AssetInfo &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AssetInfo(AssetInfo &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::String getName() const SWIFT_SYMBOL("s:13PooperTrooper9AssetInfoV4nameSSvp");
  SWIFT_INLINE_THUNK AssetType getType() const SWIFT_SYMBOL("s:13PooperTrooper9AssetInfoV4typeAA0C4TypeOvp");
  SWIFT_INLINE_THUNK swift::String getPath() const SWIFT_SYMBOL("s:13PooperTrooper9AssetInfoV4pathSSvp");
  SWIFT_INLINE_THUNK uint64_t getSize() const SWIFT_SYMBOL("s:13PooperTrooper9AssetInfoV4sizes6UInt64Vvp");
private:
  SWIFT_INLINE_THUNK AssetInfo(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK AssetInfo _make() noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetInfoVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13PooperTrooper9AssetInfoVD;
  static inline constexpr $s13PooperTrooper9AssetInfoVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AssetInfo {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AssetInfo &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AssetInfo &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AssetInfo returnNewValue(T callable) {
    auto result = AssetInfo::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<PooperTrooper::AssetInfo> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return PooperTrooper::_impl::$s13PooperTrooper9AssetInfoVMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<PooperTrooper::AssetInfo> = true;
template<>
inline const constexpr bool isOpaqueLayout<PooperTrooper::AssetInfo> = true;
template<>
struct implClassFor<PooperTrooper::AssetInfo> { using type = PooperTrooper::_impl::_impl_AssetInfo; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:13PooperTrooper16AssetMemoryUsageV") AssetMemoryUsage;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<PooperTrooper::AssetMemoryUsage> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_AssetMemoryUsage;

// Type metadata accessor for AssetMemoryUsage
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13PooperTrooper16AssetMemoryUsageVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13PooperTrooper16AssetMemoryUsageV") AssetMemoryUsage final {
public:
  SWIFT_INLINE_THUNK ~AssetMemoryUsage() noexcept {
    auto metadata = _impl::$s13PooperTrooper16AssetMemoryUsageVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AssetMemoryUsage(const AssetMemoryUsage &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper16AssetMemoryUsageVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetMemoryUsage &operator =(const AssetMemoryUsage &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper16AssetMemoryUsageVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetMemoryUsage &operator =(AssetMemoryUsage &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AssetMemoryUsage(AssetMemoryUsage &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::Int getTextureMemory() const SWIFT_SYMBOL("s:13PooperTrooper16AssetMemoryUsageV07textureD0Sivp");
  SWIFT_INLINE_THUNK swift::Int getAudioMemory() const SWIFT_SYMBOL("s:13PooperTrooper16AssetMemoryUsageV05audioD0Sivp");
  SWIFT_INLINE_THUNK swift::Int getDataMemory() const SWIFT_SYMBOL("s:13PooperTrooper16AssetMemoryUsageV04dataD0Sivp");
  SWIFT_INLINE_THUNK swift::Int getTotalMemory() const SWIFT_SYMBOL("s:13PooperTrooper16AssetMemoryUsageV05totalD0Sivp");
private:
  SWIFT_INLINE_THUNK AssetMemoryUsage() noexcept {}
  static SWIFT_INLINE_THUNK AssetMemoryUsage _make() noexcept { return AssetMemoryUsage(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }

  alignas(8) char _storage[32];
  friend class _impl::_impl_AssetMemoryUsage;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13PooperTrooper16AssetMemoryUsageVD;
  static inline constexpr $s13PooperTrooper16AssetMemoryUsageVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AssetMemoryUsage {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AssetMemoryUsage &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AssetMemoryUsage &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AssetMemoryUsage returnNewValue(T callable) {
    auto result = AssetMemoryUsage::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<PooperTrooper::AssetMemoryUsage> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return PooperTrooper::_impl::$s13PooperTrooper16AssetMemoryUsageVMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<PooperTrooper::AssetMemoryUsage> = true;
template<>
struct implClassFor<PooperTrooper::AssetMemoryUsage> { using type = PooperTrooper::_impl::_impl_AssetMemoryUsage; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_AssetType;

// Type metadata accessor for AssetType
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13PooperTrooper9AssetTypeOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO") AssetType final {
public:
  SWIFT_INLINE_THUNK ~AssetType() noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetTypeOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AssetType(const AssetType &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetTypeOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetType &operator =(const AssetType &other) noexcept {
    auto metadata = _impl::$s13PooperTrooper9AssetTypeOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AssetType &operator =(AssetType &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AssetType(AssetType &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    textures SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO8texturesyA2CmF"),
    audio SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO5audioyA2CmF"),
    fonts SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO5fontsyA2CmF"),
    shaders SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO7shadersyA2CmF"),
    data SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO4datayA2CmF")
  };

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_textures {  // impl struct for case textures
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::textures;
    }
    SWIFT_INLINE_THUNK AssetType operator()() const;
  } textures SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO8texturesyA2CmF");
  SWIFT_INLINE_THUNK bool isTextures() const;

  inline const static struct _impl_audio {  // impl struct for case audio
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::audio;
    }
    SWIFT_INLINE_THUNK AssetType operator()() const;
  } audio SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO5audioyA2CmF");
  SWIFT_INLINE_THUNK bool isAudio() const;

  inline const static struct _impl_fonts {  // impl struct for case fonts
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::fonts;
    }
    SWIFT_INLINE_THUNK AssetType operator()() const;
  } fonts SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO5fontsyA2CmF");
  SWIFT_INLINE_THUNK bool isFonts() const;

  inline const static struct _impl_shaders {  // impl struct for case shaders
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::shaders;
    }
    SWIFT_INLINE_THUNK AssetType operator()() const;
  } shaders SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO7shadersyA2CmF");
  SWIFT_INLINE_THUNK bool isShaders() const;
...
#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    switch (_getEnumTag()) {
      case 0: return cases::textures;
      case 1: return cases::audio;
      case 2: return cases::fonts;
      case 3: return cases::shaders;
      case 4: return cases::data;
      default: abort();
    }
  }

  static SWIFT_INLINE_THUNK swift::Optional<AssetType> init(const swift::String& rawValue) SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO8rawValueACSgSS_tcfc");
  static SWIFT_INLINE_THUNK swift::Array<AssetType> getAllCases() SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO8allCasesSayACGvpZ");
  SWIFT_INLINE_THUNK swift::String getRawValue() const SWIFT_SYMBOL("s:13PooperTrooper9AssetTypeO8rawValueSSvp");
private:
  SWIFT_INLINE_THUNK AssetType() noexcept {}
  static SWIFT_INLINE_THUNK AssetType _make() noexcept { return AssetType(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }
  ...
  friend class _impl::_impl_AssetType;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13PooperTrooper9AssetTypeOD;
  static inline constexpr $s13PooperTrooper9AssetTypeOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AssetType {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AssetType &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AssetType &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AssetType returnNewValue(T callable) {
    auto result = AssetType::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<PooperTrooper::AssetType> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return PooperTrooper::_impl::$s13PooperTrooper9AssetTypeOMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<PooperTrooper::AssetType> = true;
template<>
struct implClassFor<PooperTrooper::AssetType> { using type = PooperTrooper::_impl::_impl_AssetType; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO") AudioError;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<PooperTrooper::AudioError> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13PooperTrooper10AudioErrorOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO") AudioError final {
public:
  SWIFT_INLINE_THUNK ~AudioError() noexcept {
    auto metadata = _impl::$s13PooperTrooper10AudioErrorOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  enum class cases {
    fileNotFound SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO12fileNotFoundyACSScACmF"),
    invalidFormat SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO13invalidFormatyACSScACmF"),
    engineNotRunning SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO16engineNotRunningyA2CmF")
  };
...
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  ...
  inline const static struct _impl_invalidFormat {  // impl struct for case invalidFormat
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::invalidFormat;
    }
    SWIFT_INLINE_THUNK AudioError operator()(const swift::String& val) const;
  } invalidFormat SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO13invalidFormatyACSScACmF");
  SWIFT_INLINE_THUNK bool isInvalidFormat() const;
  SWIFT_INLINE_THUNK swift::String getInvalidFormat() const;

  inline const static struct _impl_engineNotRunning {  // impl struct for case engineNotRunning
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::engineNotRunning;
    }
    SWIFT_INLINE_THUNK AudioError operator()() const;
  } engineNotRunning SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO16engineNotRunningyA2CmF");
  SWIFT_INLINE_THUNK bool isEngineNotRunning() const;

#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    switch (_getEnumTag()) {
      case 0: return cases::fileNotFound;
      case 1: return cases::invalidFormat;
      case 2: return cases::engineNotRunning;
      default: abort();
    }
  }

  SWIFT_INLINE_THUNK swift::Optional<swift::String> getErrorDescription() const SWIFT_SYMBOL("s:13PooperTrooper10AudioErrorO16errorDescriptionSSSgvp");
private:
  SWIFT_INLINE_THUNK AudioError() noexcept {}
  static SWIFT_INLINE_THUNK AudioError _make() noexcept { return AudioError(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }
  ...
  alignas(8) char _storage[17];
  friend class _impl::_impl_AudioError;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13PooperTrooper10AudioErrorOD;
  static inline constexpr $s13PooperTrooper10AudioErrorOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<PooperTrooper::AudioError> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return PooperTrooper::_impl::$s13PooperTrooper10AudioErrorOMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<PooperTrooper::AudioError> = true;
template<>
struct implClassFor<PooperTrooper::AudioError> { using type = PooperTrooper::_impl::_impl_AudioError; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO") LogLevel;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<PooperTrooper::LogLevel> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13PooperTrooper8LogLevelOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO") LogLevel final {
public:
  SWIFT_INLINE_THUNK ~LogLevel() noexcept {
    auto metadata = _impl::$s13PooperTrooper8LogLevelOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  enum class cases {
    trace SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO5traceyA2CmF"),
    debug SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO5debugyA2CmF"),
    info SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO4infoyA2CmF"),
    warning SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO7warningyA2CmF"),
    error SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO5erroryA2CmF"),
    fatal SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO5fatalyA2CmF")
  };
...
#pragma clang diagnostic pop
  ...
  static SWIFT_INLINE_THUNK swift::Optional<LogLevel> init(int32_t rawValue) SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO8rawValueACSgs5Int32V_tcfc");
  static SWIFT_INLINE_THUNK swift::Array<LogLevel> getAllCases() SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO8allCasesSayACGvpZ");
  SWIFT_INLINE_THUNK int32_t getRawValue() const SWIFT_SYMBOL("s:13PooperTrooper8LogLevelO8rawValues5Int32Vvp");
private:
  SWIFT_INLINE_THUNK LogLevel() noexcept {}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13PooperTrooper8LogLevelOD;
  static inline constexpr $s13PooperTrooper8LogLevelOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<PooperTrooper::LogLevel> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return PooperTrooper::_impl::$s13PooperTrooper8LogLevelOMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<PooperTrooper::LogLevel> = true;
template<>
struct implClassFor<PooperTrooper::LogLevel> { using type = PooperTrooper::_impl::_impl_LogLevel; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_INLINE_THUNK bool hasRemoveAdsPurchasedSync() noexcept SWIFT_SYMBOL("s:13PooperTrooper25hasRemoveAdsPurchasedSyncSbyF") SWIFT_WARN_UNUSED_RESULT {
  return PooperTrooper::_impl::$s13PooperTrooper25hasRemoveAdsPurchasedSyncSbyF();
}
...
SWIFT_INLINE_THUNK swift::String loadGameDataSync() noexcept SWIFT_SYMBOL("s:13PooperTrooper16loadGameDataSyncSSyF") SWIFT_WARN_UNUSED_RESULT {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(result, PooperTrooper::_impl::$s13PooperTrooper16loadGameDataSyncSSyF());
  });
}
  ...
  SWIFT_INLINE_THUNK  bool AssetError::isFileNotFound() const {
    return *this == AssetError::fileNotFound;
  }
  SWIFT_INLINE_THUNK swift::String AssetError::getFileNotFound() const {
    if (!isFileNotFound()) abort();
    alignas(AssetError) unsigned char buffer[sizeof(AssetError)];
    auto *thisCopy = new(buffer) AssetError(*this);
    char * _Nonnull payloadFromDestruction = thisCopy->_destructiveProjectEnumData();
  ...
  SWIFT_INLINE_THUNK AssetError AssetError::_impl_metalNotAvailable::operator()() const {
    auto result = AssetError::_make();
    result._destructiveInjectEnumTag(1);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetError::isMetalNotAvailable() const {
    return *this == AssetError::metalNotAvailable;
  }
  SWIFT_INLINE_THUNK AssetError AssetError::_impl_unknownError::operator()() const {
    auto result = AssetError::_make();
    result._destructiveInjectEnumTag(2);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetError::isUnknownError() const {
    return *this == AssetError::unknownError;
  }
  SWIFT_INLINE_THUNK swift::Optional<swift::String> AssetError::getErrorDescription() const {
  return swift::_impl::_impl_Optional<swift::String>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16(result, PooperTrooper::_impl::$s13PooperTrooper10AssetErrorO16errorDescriptionSSSgvg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16(_getOpaquePointer())));
  });
  }
  SWIFT_INLINE_THUNK swift::String AssetInfo::getName() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(result, PooperTrooper::_impl::$s13PooperTrooper9AssetInfoV4nameSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK AssetType AssetInfo::getType() const {
  return PooperTrooper::_impl::_impl_AssetType::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint8_t_0_1(result, PooperTrooper::_impl::$s13PooperTrooper9AssetInfoV4typeAA0C4TypeOvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String AssetInfo::getPath() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(result, PooperTrooper::_impl::$s13PooperTrooper9AssetInfoV4pathSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK uint64_t AssetInfo::getSize() const {
  return PooperTrooper::_impl::$s13PooperTrooper9AssetInfoV4sizes6UInt64Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Int AssetMemoryUsage::getTextureMemory() const {
  return PooperTrooper::_impl::$s13PooperTrooper16AssetMemoryUsageV07textureD0Sivg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK swift::Int AssetMemoryUsage::getAudioMemory() const {
  return PooperTrooper::_impl::$s13PooperTrooper16AssetMemoryUsageV05audioD0Sivg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK swift::Int AssetMemoryUsage::getDataMemory() const {
  return PooperTrooper::_impl::$s13PooperTrooper16AssetMemoryUsageV04dataD0Sivg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK swift::Int AssetMemoryUsage::getTotalMemory() const {
  return PooperTrooper::_impl::$s13PooperTrooper16AssetMemoryUsageV05totalD0Sivg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint64_t_16_24_uint64_t_24_32(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK AssetType AssetType::_impl_textures::operator()() const {
    auto result = AssetType::_make();
    result._destructiveInjectEnumTag(0);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetType::isTextures() const {
    return *this == AssetType::textures;
  }
  SWIFT_INLINE_THUNK AssetType AssetType::_impl_audio::operator()() const {
    auto result = AssetType::_make();
    result._destructiveInjectEnumTag(1);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetType::isAudio() const {
    return *this == AssetType::audio;
  }
  SWIFT_INLINE_THUNK AssetType AssetType::_impl_fonts::operator()() const {
    auto result = AssetType::_make();
    result._destructiveInjectEnumTag(2);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetType::isFonts() const {
    return *this == AssetType::fonts;
  }
  SWIFT_INLINE_THUNK AssetType AssetType::_impl_shaders::operator()() const {
    auto result = AssetType::_make();
    result._destructiveInjectEnumTag(3);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetType::isShaders() const {
    return *this == AssetType::shaders;
  }
  SWIFT_INLINE_THUNK AssetType AssetType::_impl_data::operator()() const {
    auto result = AssetType::_make();
    result._destructiveInjectEnumTag(4);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AssetType::isData() const {
    return *this == AssetType::data;
  }
  SWIFT_INLINE_THUNK swift::Optional<AssetType> AssetType::init(const swift::String& rawValue) {
  ...
  return swift::_impl::_impl_Optional<AssetType>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint8_t_0_1(result, PooperTrooper::_impl::$s13PooperTrooper9AssetTypeO8rawValueACSgSS_tcfC(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_rawValue))));
  });
  }
  SWIFT_INLINE_THUNK swift::Array<AssetType> AssetType::getAllCases() {
  return swift::_impl::_impl_Array<AssetType>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_void_ptr_0_8(result, PooperTrooper::_impl::$s13PooperTrooper9AssetTypeO8allCasesSayACGvgZ());
  });
  }
  SWIFT_INLINE_THUNK swift::String AssetType::getRawValue() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_void_ptr_8_16(result, PooperTrooper::_impl::$s13PooperTrooper9AssetTypeO8rawValueSSvg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint8_t_0_1(_getOpaquePointer())));
  });
  }
  SWIFT_INLINE_THUNK AudioError AudioError::_impl_fileNotFound::operator()(const swift::String& val) const {
    auto result = AudioError::_make();
    alignas(swift::String) unsigned char buffer[sizeof(swift::String)];
    auto *valCopy = new(buffer) swift::String(val);
    swift::_impl::implClassFor<swift::String>::type::initializeWithTake(result._getOpaquePointer(), swift::_impl::implClassFor<swift::String>::type::getOpaquePointer(*valCopy));
  ...
  SWIFT_INLINE_THUNK  bool AudioError::isFileNotFound() const {
    return *this == AudioError::fileNotFound;
  }
  SWIFT_INLINE_THUNK swift::String AudioError::getFileNotFound() const {
    if (!isFileNotFound()) abort();
  ...
  SWIFT_INLINE_THUNK AudioError AudioError::_impl_invalidFormat::operator()(const swift::String& val) const {
    auto result = AudioError::_make();
    alignas(swift::String) unsigned char buffer[sizeof(swift::String)];
    auto *valCopy = new(buffer) swift::String(val);
    swift::_impl::implClassFor<swift::String>::type::initializeWithTake(result._getOpaquePointer(), swift::_impl::implClassFor<swift::String>::type::getOpaquePointer(*valCopy));
  ...
  SWIFT_INLINE_THUNK  bool AudioError::isInvalidFormat() const {
    return *this == AudioError::invalidFormat;
  }
  SWIFT_INLINE_THUNK swift::String AudioError::getInvalidFormat() const {
    if (!isInvalidFormat()) abort();
    alignas(AudioError) unsigned char buffer[sizeof(AudioError)];
    auto *thisCopy = new(buffer) AudioError(*this);
    char * _Nonnull payloadFromDestruction = thisCopy->_destructiveProjectEnumData();
    return swift::_impl::implClassFor<swift::String>::type::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
  ...
  SWIFT_INLINE_THUNK AudioError AudioError::_impl_engineNotRunning::operator()() const {
    auto result = AudioError::_make();
    result._destructiveInjectEnumTag(2);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AudioError::isEngineNotRunning() const {
    return *this == AudioError::engineNotRunning;
  }
  SWIFT_INLINE_THUNK swift::Optional<swift::String> AudioError::getErrorDescription() const {
  return swift::_impl::_impl_Optional<swift::String>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16(result, PooperTrooper::_impl::$s13PooperTrooper10AudioErrorO16errorDescriptionSSSgvg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint64_t_0_8_uint64_t_8_16_uint8_t_16_17(_getOpaquePointer())));
  });
  }
  ...
  return swift::_impl::_impl_Optional<LogLevel>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_uint8_t_0_1(result, PooperTrooper::_impl::$s13PooperTrooper8LogLevelO8rawValueACSgs5Int32V_tcfC(rawValue));
  });
  }
  SWIFT_INLINE_THUNK swift::Array<LogLevel> LogLevel::getAllCases() {
  return swift::_impl::_impl_Array<LogLevel>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    PooperTrooper::_impl::swift_interop_returnDirect_PooperTrooper_void_ptr_0_8(result, PooperTrooper::_impl::$s13PooperTrooper8LogLevelO8allCasesSayACGvgZ());
  });
  }
  SWIFT_INLINE_THUNK int32_t LogLevel::getRawValue() const {
  return PooperTrooper::_impl::$s13PooperTrooper8LogLevelO8rawValues5Int32Vvg(PooperTrooper::_impl::swift_interop_passDirect_PooperTrooper_uint8_t_0_1(_getOpaquePointer()));
  }

class AssetManager { } SWIFT_UNAVAILABLE_MSG("actor-isolated class 'AssetManager' can not be exposed to C++");

class MetalRenderer { } SWIFT_UNAVAILABLE_MSG("actor-isolated class 'MetalRenderer' can not be exposed to C++");

class SwiftLog { } SWIFT_UNAVAILABLE_MSG("'SwiftLog' is a zero sized value type, it cannot be exposed to C++ yet");

template<class T_0_0>
#ifdef __cpp_concepts
requires swift::isUsableInGenericContext<T_0_0>
#endif // __cpp_concepts
class TouchInputDelegate { } SWIFT_UNAVAILABLE_MSG("actor-isolated protocol 'TouchInputDelegate' can not be exposed to C++");
