...
namespace Resources
{
	...
	inline const char* GotScore = "resources/ui/bubble.mp3";
	...
	inline const char* SnowBall = "resources/enemies/Snowball.png";

	// Level Five Assets (Castle)
	...
	inline const char* TorchPillar = "resources/environment/TorchPillar.png"; // 96x138 split into 4 frames
	inline const char* Chandelier = "resources/environment/castlelevelchandelier.png"; // 32x34 split into 4 frames
	inline const char* FloorTorch = "resources/environment/castlelevelfloortorch.png"; // 20x64 split into 4 frames
	...
	inline const char* RatKingKill = "resources/sounds/RatKingKill.ogg";
	inline const char* ToiletPaperProjectilePic = "resources/enemies/ToiletPaperProjectile.png";

	inline const char* BossBarFrame = "resources/ui/BossBarFrame.png";
	...
	inline const char* PlayButton = "resources/mainmenu/PlayButton.png";
	inline const char* PlayButtonFocused = "resources/mainmenu/PlayButtonFocused.png";
	inline const char* PlayButtonSelected = "resources/mainmenu/PlayButtonSelect.png";
	inline const char* QuickPlayButton = "resources/mainmenu/QuickPlayButton.png";
	inline const char* QuickPlayButtonFocused = "resources/mainmenu/QuickPlayButtonFocused.png";
	inline const char* QuickPlayButtonSelected = "resources/mainmenu/QuickPlayButtonSelect.png";
	inline const char* OptionsButton = "resources/mainmenu/OptionButton.png";
	inline const char* OptionsButtonFocused = "resources/mainmenu/OptionButtonFocused.png";
	inline const char* OptionsButtonSelected = "resources/mainmenu/OptionButtonSelect.png";
	...
	// UI
	inline const char* ScoreBoard = "resources/ui/Score.png";
	inline const char* TurdHeart = "resources/ui/TurdHeartSmall.png";
	...
	inline const char* TurdHeart0ThirdHollow1Third = "resources/ui/TurdHeart0ThirdHollow1Third.png";
	inline const char* TurdHeart0HalfHollow1Half = "resources/ui/TurdHeart0HalfHollow1Half.png";
	inline const char* TurdHeart1Half = "resources/ui/TurdHeart1Half.png";
	inline const char* TurdHeart1HalfHollow = "resources/ui/TurdHeart1HalfHollow.png";
	inline const char* TurdHeart1Third = "resources/ui/TurdHeart1Third.png";
	inline const char* TurdHeart1ThirdHollow = "resources/ui/TurdHeart1ThirdHollow.png";
	inline const char* TurdHeart1ThirdHollow1Third = "resources/ui/TurdHeart1ThirdHollow1Third.png";
	inline const char* TurdHeart2Thirds = "resources/ui/TurdHeart2Thirds.png";
	inline const char* TurdHeart2ThirdsHollow = "resources/ui/TurdHeart2ThirdsHollow.png";
	inline const char* TurdHeart2ThirdsHollow2Thirds = "resources/ui/TurdHeart2ThirdsHollow2Thirds.png";
	...
	inline const char* TurdPointMenuBorder = "resources/ui/SkillMenuBorder.png";
	inline const char* TurdPointInfo = "resources/ui/SkillPointInfoBackground.png";
	inline const char* TPMenuButtonLocked = "resources/ui/TurdPointButton.png";
	inline const char* TPMenuButtonAvailable = "resources/ui/TurdPointButtonAvailable.png";
	inline const char* TPMenuButtonFocused = "resources/ui/TurdPointButtonFocused.png";
	inline const char* TPMenuButtonSelected = "resources/ui/TurdPointButtonClaimed.png";

	// Pause Menu
	inline const char* HatFrameNormal = "resources/ui/HatFrame.png";
	inline const char* HatFrameHover = "resources/ui/HatFrameHover.png";
	inline const char* HatFrameSelected = "resources/ui/HatFrameSelected.png";
	inline const char* HatFrameLocked = "resources/ui/HatFrameLocked.png";
	...
	inline const char* RatCopterKill = "resources/sounds/ratkill.ogg";
	...
	inline const char* ToiletPaperKill = "resources/sounds/tpkill.ogg";

	// Options Menu
	inline const char* Mutebutton = "resources/ui/mutebutton.png";
	inline const char* Mutebuttonhover = "resources/ui/mutebuttonhover.png";
	inline const char* Mutebuttonclicked = "resources/ui/mutebuttonclicked.png";
	inline const char* Mutebuttonlocked = "resources/ui/mutebuttonlocked.png";
	inline const char* Mutebuttonlockedhover = "resources/ui/mutebuttonlockedhover.png";
	inline const char* Mutebuttonlockedclicked = "resources/ui/mutebuttonlockedclicked.png";
	inline const char* Minusbutton = "resources/ui/minusbutton.png";
	inline const char* Minusbuttonhover = "resources/ui/minusbuttonhover.png";
	inline const char* Minusbuttonclicked = "resources/ui/minusbuttonclicked.png";
	inline const char* Plusbutton = "resources/ui/plusbutton.png";
	inline const char* Plusbuttonhover = "resources/ui/plusbuttonhover.png";
	inline const char* Plusbuttonclicked = "resources/ui/plusbuttonclicked.png";
	inline const char* Volumemeterfull = "resources/ui/volumemeterfull.png";
	inline const char* Volumemeterempty = "resources/ui/volumemeterempty.png";
	...
	inline const char* PooHeartInvisible = "resources/objects/PooHeartRainbowBeam.png";

	// Game-Over Stuff
	inline const char* GameOverMusic = "resources/music/GameOver.mp3";
	inline const char* GameOverBackground = "resources/ui/GameOverBackground.png";
