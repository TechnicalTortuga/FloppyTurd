...
// ============================================================================
// CAMERA AND MATRIX TYPES (Forward declarations)
// ============================================================================
...
#else
// Non-iOS platform - include raylib for type definitions
#include "raylib.h"
#endif
...
// Gesture constants (cross-platform)
